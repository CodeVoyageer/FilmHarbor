...
const PopularCrimeSeriesList = () => {
    const [popularCrimeSeries, setPopularCrimeSeries] = useState([]);
    const { addMovie } = useMovies();
    useEffect(() => {
        const fetchPopularCrimeSeries = async () => {
    ...
    return (
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>Crime Series:</h1>
...
export default PopularCrimeSeriesList;