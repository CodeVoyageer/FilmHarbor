    ...
    useEffect(() => {
        const fetchPopularHistoryMovies = async () => {
            ...
            try {
                ...
                setPopularHistoryMovies(result.results);
            } catch (error) {
                console.error('Błąd podczas pobierania danych:', error);
            }
        };

        fetchPopularHistoryMovies();
    }, []);
    const settings = {
        dots: true,
        infinite: true,
    ...
    return(
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>History Movies:</h1>
                ...
                <Slider ref={slider} {...settings}>
                    {popularHistoryMovies.length > 0 && popularHistoryMovies
...
export default PopularHistoryMoviesList ;