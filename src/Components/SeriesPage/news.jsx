...
const PopularNewsSeriesList = () => {
    const [popularNewsSeries, setPopularNewsSeries] = useState([]);

    useEffect(() => {
        const fetchPopularNewsSeries = async () => {
            ...
            try {
                ...
                setPopularNewsSeries(result.results);
            } catch (error) {
                console.error('Błąd podczas pobierania danych:', error);
            }
        };

        fetchPopularNewsSeries();
    }, []);
    ...
    return (
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>News Series:</h1>
...
export default PopularNewsSeriesList;