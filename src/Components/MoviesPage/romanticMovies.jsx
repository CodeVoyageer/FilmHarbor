...
const PopularRomanticMoviesList  = ()=> {
    const [popularRomanticMovies, setPopularRomanticMovies] = useState([]);
    const { addMovie } = useMovies();
    useEffect(() => {
        const fetchPopularRomanticMovies = async () => {
            ...
            try {
                ...
                setPopularRomanticMovies(result.results);
            } catch (error) {
                console.error('Błąd podczas pobierania danych:', error);
            }
        };

        fetchPopularRomanticMovies();
    }, []);
    const settings = {
        dots: false,
        infinite: true,
    ...
    return(
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>Romantic Movies:</h1>
                ...
                <Slider ref={slider} {...settings}>
                    {popularRomanticMovies.length > 0 && popularRomanticMovies
...
export default PopularRomanticMoviesList ;