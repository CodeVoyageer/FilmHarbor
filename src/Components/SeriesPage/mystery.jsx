...
const PopularMysterySeriesList = () => {
    const [popularMysterySeries, setPopularMysterySeries] = useState([]);
    const { addMovie } = useMovies();
    useEffect(() => {
        const fetchPopularMysterySeries = async () => {
            ...
            try {
                ...
                setPopularMysterySeries(result.results);
            } catch (error) {
                console.error('Błąd podczas pobierania danych:', error);
            }
        };

        fetchPopularMysterySeries();
    }, []);
    ...
    return (
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>Mystery Series:</h1>
...
export default PopularMysterySeriesList;