    ...
    return(
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>Horror Movies:</h1>
                ...
                <Slider ref={slider} {...settings}>
                    {popularHorrorMovies.length > 0 && popularHorrorMovies
...
export default PopularHorrorMoviesList ;