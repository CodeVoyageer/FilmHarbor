...
const PopularKidsSeriesList = () => {
    ...
    useEffect(() => {
        const fetchPopularKidsSeries = async () => {
            ...
            try {
                ...
                setPopularKidsSeries(result.results);
            } catch (error) {
                console.error('Błąd podczas pobierania danych:', error);
            }
        };

        fetchPopularKidsSeries();
    }, []);
    ...
    return (
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>Kids Series:</h1>
...
export default PopularKidsSeriesList;