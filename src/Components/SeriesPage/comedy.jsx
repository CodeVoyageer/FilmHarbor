...
const PopularComedySeriesList = () => {
    const [popularComedySeries, setPopularComedySeries] = useState([]);
    const { addMovie } = useMovies();
    const { user } = useUser();
    useEffect(() => {
        const fetchPopularComedySeries = async () => {
            ...
            try {
                ...
                setPopularComedySeries(result.results);
            } catch (error) {
                console.error('Error while fetching data:', error);
            }
        };

        fetchPopularComedySeries();
    }, []);
    ...
    return (
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>Comedy Series:</h1>
...
export default PopularComedySeriesList;