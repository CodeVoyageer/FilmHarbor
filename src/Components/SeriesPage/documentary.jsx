...
const PopularDocumentarySeriesList = () => {
    const [popularDocumentarySeries, setPopularDocumentarySeries] = useState([]);
    const { addMovie } = useMovies();
    useEffect(() => {
        const fetchPopularDocumentarySeries = async () => {
            ...
            try {
                ...
                setPopularDocumentarySeries(result.results);
            } catch (error) {
                console.error('Błąd podczas pobierania danych:', error);
            }
        };

        fetchPopularDocumentarySeries();
    }, []);
    ...
    return (
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>Documentary Series:</h1>
                ...
                <Slider ref={slider} {...settings}>
                    {popularDocumentarySeries.map((item) => (
...
export default PopularDocumentarySeriesList;