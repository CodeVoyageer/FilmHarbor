...
const PopularWarSeriesList = () => {
    const [popularWarSeries, setPopularWarSeries] = useState([]);

    useEffect(() => {
        const fetchPopularWarSeries = async () => {
            ...
            try {
                ...
                setPopularWarSeries(result.results);
            } catch (error) {
                console.error('Błąd podczas pobierania danych:', error);
            }
        };

        fetchPopularWarSeries();
    }, []);
    ...
    return (
        <>
            <section className='slider-section'>
                <h1 className='slider-section_headeing'>War & Politics Series:</h1>
...
export default PopularWarSeriesList;